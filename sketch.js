...
var { warrior_running, warrior_collided, warrior } = newFunction();  
...
function newFunction() {
    ...
    return { warrior_running, warrior_collided, warrior };
}
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") ) {
      warrior.velocityY = -14;
    }
  
    warrior.velocityY = warrior.velocityY + 1.0
